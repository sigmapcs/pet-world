...
// saludo()
// despedida()
(0, _activeMenu.activeMenu)(); // import {saludo, despedida} from "./modules/example"
...
if (bodyClass.classList.contains('Inicio')) {
  (0, _slide.slidePCS)(document.getElementById('slides'), document.getElementById('slide-navigation'), 1000, 5000);
};

if (bodyClass.classList.contains('Promociones')) {
  (0, _promos.getMonts)(document.getElementById('month'));
  (0, _promos.getPromos)(document.getElementById('promo-store'), document.getElementById('promo-hospital'));
}
...
},{"./modules/active-menu":29,"./modules/promos":30,"./modules/slide":31}],29:[function(require,module,exports){
'use strict';
...
var getPromos = exports.getPromos = function getPromos(eleStore, eleHospital) {
  _axios2.default.get(url).then(function (res) {
    return drawPromos(res.data, eleStore, eleHospital);
  }).catch(function (err) {
